        ...
        {(step === 'select' || step === 'map') && (
          <div className="bg-white rounded-xl shadow-sm p-5">
            ...
            <input
              ...
              disabled={loading}
              className="cursor-pointer text-sm text-gray-500 file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-600 file:text-white hover:file:bg-blue-700 file:cursor-pointer"
            />
